...
_See code: [src/commands/chipps/data/file/upload.ts](https://github.com/ClayChipps/sf-chipps-data/blob/0.6.4/src/commands/chipps/data/file/upload.ts)_
...
_See code: [src/commands/chipps/data/files/upload.ts](https://github.com/ClayChipps/sf-chipps-data/blob/0.6.4/src/commands/chipps/data/files/upload.ts)_
<!-- commandsstop -->
